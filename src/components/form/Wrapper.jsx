      ...
      <Fragment>
        ...
        <Switch>
          <Route
            ...
            render={() => (
              <Account onSubmit={this.handleSubmitMethod('profile', 2)} />
            )}
          />
          <Route
            path="/user/profile/:id?"
            render={() => (
              <Profile onSubmit={this.handleSubmitMethod('contacts', 3)} />
            )}
          />
          <Route
            path="/user/contacts/:id?"
            render={() => (
              <Contacts onSubmit={this.handleSubmitMethod('capabilities', 4)} />
            )}
          />
          <Route
            path="/user/capabilities/:id?"
            render={() => (
              <Capabilities onSubmit={this.handleSubmitMethodWithSave()} />
            )}
          />
        </Switch>
      </Fragment>
