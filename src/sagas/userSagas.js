...
import {
    ...
    SAVE_DRAFT_USER, SAVE_DRAFT_USER_FAILURE,
    FILL_DRAFT_USER, FILL_DRAFT_USER_FAILURE,
    DELETE_DRAFT_USER, DELETE_DRAFT_USER_REQUEST, DELETE_DRAFT_USER_SUCCESS, DELETE_DRAFT_USER_FAILURE,
    CLEAR_USER,
