...
import {
    GET_LANGUAGES_REQUEST, GET_LANGUAGES_SUCCESS, GET_LANGUAGES_FAILURE,
    GET_SKILLS_REQUEST, GET_SKILLS_SUCCESS, GET_SKILLS_FAILURE,
    GET_HOBBIES_REQUEST, GET_HOBBIES_SUCCESS, GET_HOBBIES_FAILURE
