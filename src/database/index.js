        ...
        if (indexedDB) {
          ...
          connection.onupgradeneeded = async e => {
            ...
            if (!upgradeDB.objectStoreNames.contains('users')) {
              ...
              objectStore.createIndex('users_id_unique', 'id', {
                unique: true,
              });
              objectStore.createIndex('users_username_unique', 'username', {
                unique: true,
              });
              objectStore.createIndex('users_email_unique', 'email', {
                unique: true,
              });
            }
            ...
            if (!upgradeDB.objectStoreNames.contains('languages')) {
              ...
              objectStore.createIndex('languages_id_unique', 'id', {
                unique: true,
              });
              objectStore.createIndex('languages_value_unique', 'value', {
                unique: true,
              });
            }
            ...
            if (!upgradeDB.objectStoreNames.contains('skills')) {
              ...
              objectStore.createIndex('skills_id_unique', 'id', {
                unique: true,
              });
            }
            ...
            if (!upgradeDB.objectStoreNames.contains('hobbies')) {
              ...
              objectStore.createIndex('hobbies_id_unique', 'id', {
                unique: true,
              });
            }
            ...
            if (!upgradeDB.objectStoreNames.contains('draft')) {
              ...
              objectStore.createIndex('draft_id_unique', 'id', {
                unique: true,
              });
            }
  ...
  static save = async (table, data) => {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const request = Database.instance
